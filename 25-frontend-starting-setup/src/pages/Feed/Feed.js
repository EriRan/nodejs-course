  ...
  finishEditHandler = (postData) => {
    ...
    fetch("http://localhost:8080/post-image", {
      ...
      .then((fileResData) => {
        ...
        // Backend and frontend schema must have the same definitions. Pay attention to the exclamation marks!
        let graphqlQuery = {
          query: `
  ...
  deletePostHandler = (postId) => {
    ...
    fetch("http://localhost:8080/graphql", {
      ...
      .then((resData) => {
        ...
        console.log(resData);
        // Just reload to quickly implement view update for delete
        this.loadPosts();
      })
      .catch((err) => {
        console.log(err);
